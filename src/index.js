...
var Dashboard = React.createClass({
  ...
  _handleIndicators: function(data, partner) {
	
	if(partner!== null)
	{
      filtereddata = data.filter(function (ip) {


    return ip.ip.toLowerCase() == partner;
});
    }
    else
    {
	...
	this.setState({data: filtereddata});
        ...
        if (this.state.currentPartner !== _partner) {
            ...
            this._handleIndicators(this.state.data, _partner);
        }
    },
